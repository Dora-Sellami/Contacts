...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _btnConnexion = (Button) findViewById(R.id.btnConnection);
    ...
    private class bg extends AsyncTask <String,Void,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String connstr = "http://192.168.56.1/contacts/login.php";
            try {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("succes")){
                Intent i = new Intent();
                i.setClass(c.getApplicationContext(),ContactsActivity.class);
                startActivity(i);
            }
        }
    }
